  ...
  const blogPosts = [
    {
      ...
      title: "🔗 Conecta TI",
      excerpt: "Sistema de gestão de chamados e ativos de TI usando Microsoft Lists + Power Automate. Centralizou solicitações, automatizou aprovações e reduziu tempo de resposta.",
      date: "Projeto GIZ Brasil",
      readTime: "Case real",
    ...
    },
    {
      ...
      excerpt: "Plataforma de controle patrimonial com rastreamento, manutenção e relatórios automáticos. Eliminou planilhas manuais e trouxe visibilidade total dos ativos da organização.",
      date: "Projeto GIZ Brasil",
      readTime: "Case real",
    ...
    },
    {
      ...
      excerpt: "Sistema de gestão operacional de estações de campo com check-ins, incidentes e relatórios. Digitalizou processos antes feitos em papel, trazendo dados em tempo real.",
      date: "Projeto GIZ Brasil",
      readTime: "Case real",
      gradient: "from-[#4A8CFF] to-[#FF7ACB]",
    },
    {
      category: "Negócios",
      categoryColor: "#4A8CFF",
